...
namespace FolkloreArchives.MapGen
{
    public static class EnvironmentBuilder
    {
        ...
        static void BuildWind(Transform parent)
        {
            ...
            // owner: "bajale muchisimo al viento" -- puesto explícito acá (no solo el
            // default en WindAmbience.cs): un componente ya existente en la escena
            // guarda su propio valor serializado, que un cambio de default en código
            // NO pisa hasta que se re-crea desde cero.
            wind.volume = 0.015f;
        }
