    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings input) : SV_Target
            {
                ...
                // PSX dither/posterizado DESACTIVADO (owner: llenaba los oscuros de
                // puntitos grises = "todo blanco/estática"). Para reactivar, descomentar
                // y poner _PosterizeLevels > 1 en el feature.
                // if (_PosterizeLevels > 1.5)
                // {
                //     int2 pix = int2(fmod(input.positionCS.xy, 4.0));
                //     float d = _BayerP[pix.y * 4 + pix.x] - 0.5;
